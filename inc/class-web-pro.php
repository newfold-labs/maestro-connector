...
class Web_Pro {
	...
	protected $key_key          = 'bh_maestro_reference_id';
	protected $revoke_token_key = 'bh_maestro_revoke_token';
	private $platform           = 'https://api-maestro.webpropanel.com/wordpress-plugin-controller/wp-plugin';
	...
	private function send_access_token() {
		...
		$jwt          = new Token();
		$access_token = $jwt->generate_token( $this->key, $this->user->ID );
